...
public class ItemInHandRenderer {
    ...
    public void submitHandsWithItems(
        final float frameInterp, final PoseStack poseStack, final SubmitNodeCollector submitNodeCollector, final LocalPlayer player, final int lightCoords
    ) {
    ...
    @VisibleForTesting
    static ItemInHandRenderer.HandRenderSelection evaluateWhichHandsToRender(final LocalPlayer player) {
    ...
    private static ItemInHandRenderer.HandRenderSelection selectionUsingItemWhileHoldingBowLike(final LocalPlayer player) {
    ...
    enum HandRenderSelection {
        ...
        public static ItemInHandRenderer.HandRenderSelection onlyForHand(final InteractionHand hand) {
