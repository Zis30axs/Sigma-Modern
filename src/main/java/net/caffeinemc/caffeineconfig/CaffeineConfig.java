...
public final class CaffeineConfig {
    ...
    // MODIFIED for porting: was ServiceLoader.load(CaffeineConfigPlatform.class).findFirst().get(); the loader-provided
    // service implementation is replaced by the direct reference below.
    private static final CaffeineConfigPlatform PLATFORM = new VanillaCaffeineConfigPlatform();
