...
public class BoxCullingFrustum extends Frustum implements net.caffeinemc.mods.sodium.client.render.viewport.frustum.Frustum, ViewportProvider,
	com.seibel.distanthorizons.api.interfaces.override.rendering.IDhApiShadowCullingFrustum { // MODIFIED for porting: iris compat.dh MixinBoxCullingFrustum
    /*
      MODIFIED for porting: was iris's compat.dh MixinBoxCullingFrustum. Distant Horizons calls these to cull its LOD
